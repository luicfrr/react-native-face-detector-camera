...
import com.facedetectorcamera.CameraViewHelper.addExifData
import com.facedetectorcamera.CameraViewHelper.getExifData
import com.facedetectorcamera.CameraViewHelper.setExifData
import com.facedetectorcamera.PictureOptions
import com.facedetectorcamera.utils.FileSystemUtils
...
private const val OUT_OF_MEMORY_EXCEPTION_MSG =
    "Cannot allocate enough space to process the taken picture."
...
class ResolveTakenPicture(
    ...
    private fun processImage(): Bundle? {
        ...
        try {
            ...
            when (e) {
                is Resources.NotFoundException -> promise.reject(
                    ERROR_TAG,
    ...
    private fun writeStreamToFile(inputStream: ByteArrayOutputStream): String? {
        try {
            val outputPath =
                FileSystemUtils.generateOutputPath(directory, DIRECTORY_NAME, EXTENSION)
    ...
    private fun decodeAndRotateBitmap(
        imageData: ByteArray,
        angle: Int,
