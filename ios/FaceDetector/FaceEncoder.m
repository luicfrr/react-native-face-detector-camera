...
@property FaceDetectionAngleTransformBlock angleTransformer;

@end

@implementation FaceEncoder
...
{
  FaceDetectionAngleTransformBlock transformer = ^(float angle) {return angle;};
  return [self initWithTransform:pointTransformer withRotationTransform:transformer];
}

- (instancetype)initWithRotationTransform:(FaceDetectionAngleTransformBlock)rotationTransform
{
